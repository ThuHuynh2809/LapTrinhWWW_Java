...
public class ProductPriceRepository {
    ...
    public List<ProductPrice> getAll(long id) {
        ...
        try {
            ...
            List<ProductPrice> list = em.createNativeQuery(
                    "select * from product_price where product_id = " + id + " order by price_date_time DESC",
                    ProductPrice.class).getResultList();
    ...
    public List<ProductPrice> getFromXToY(long id, int x, int y) {
        ...
        try {
            ...
            String sql = "SELECT * FROM product_price  where product_id = " + id
                    + " order by price_date_time DESC LIMIT " + from + " OFFSET " + to;
